...
public partial class BdClientesContext : DbContext
{
    ...
    {
        // Solo se usa en tiempo de diseño (comandos "dotnet ef ..."), ya que en
        // tiempo de ejecución Program.cs configura el contexto vía DI con
        // AddDbContext, dejando optionsBuilder.IsConfigured en true.
